            ...
            <div className='w-full max-w-[1225px] mx-[20px]'>
                <div className='flex flex-col md:flex-row md:justify-between gap-[20px] md:gap-[35px]'>
                    {BlogData.map((obj: BlogType, index: number) => (
                        <button key={index} className='min-h-[200px] md:min-h-[253px] py-[20px] md:py-[25px] flex flex-col justify-between items-center w-full rounded-[10px] border-[2px] border-beighe bg-bcg hover:bg-bcg_2 active:bg-beighe overflow-hidden transactioin-all duration-300'>
