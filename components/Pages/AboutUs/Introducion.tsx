            ...
            <div className='w-full max-w-[1225px] mx-[20px]'>
                <div className='w-full grid md:grid-cols-2 gap-[35px]'>
                    <span className='text-[18px] text-dark'>
                        ...
                        <br /><br />
                        In addition to our Pashut Laledet HypnoBirthing childbirth education classes we offer birthing families a vast network of pregnancy and birth professionals who have studied our techniques. Look through our website to find doulas, midwives, lactation consultants, postpartum doulas and other birth professionals who support families with the Pashut Laledet HypnoBirthing approach.
                        <br /><br />
