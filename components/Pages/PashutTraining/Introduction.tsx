        ...
        <div className='grid lg:grid-cols-2 items-center gap-[15px] lg:gap-[35px]'>
            <div className='w-full max-lg:row-start-2 text-dark flex flex-col gap-[15px] lg:gap-[20px]'>
                <div className={`hidden lg:block text-[30px] md:text-[40px] lg:text-[44px] text-center ${lngId === 0 ? 'md:text-left' : 'md:text-right'} font-light italic`}>
                    {t('Pashut Laledet HypnoBirthing Educator Training')}
                </div>
                <div className={`text-[16px] md:text-[18px] lg:text-[20px] text-center ${lngId === 0 ? 'md:text-left' : 'md:text-right'}`}>
                    {t('Learn to teach families how to have gentle and joyous births!')}
                </div>
                ...
                <div className='flex flex-col md:flex-row gap-[15px] md:gap-[20px]'>
                    <MiddleButton text='to register' link='/signup?type=2' />
                    <MiddleButton text='contact us' type={1} link='/contact' />
                </div>
            </div>
            <div className='w-full h-full flex flex-col gap-[15px] items-center'>
