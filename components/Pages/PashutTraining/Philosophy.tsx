...
export default function Philosophy() {
    return (
        <div className='grid md:grid-cols-2 gap-[20px] lg:gap-[35px]'>
            ...
            <img draggable='false' src='\img\educator3.png' alt='' className={`w-full h-full max-md:max-h-[486px] object-cover rounded-[10px] lg:rounded-[20px] ${process.env.DEV_MODE ? 'blur-lg':''}`} />
        </div>
    )
}