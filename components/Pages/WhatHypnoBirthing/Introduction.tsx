        ...
        <div className='w-full flex justify-center'>
            <div className='w-full max-w-[1225px] mx-[20px]'>
                <div className='w-full grid md:grid-cols-2 gap-[35px]'>
                    ...
                    <VideoCard title='What is HypnoBirthing?' code='YGxKPJDzok8' style='w-full aspect-w-16 aspect-h-9 min-h-[177px]' />
                    <img draggable='false' src='/img/whathypno2.png' alt='' className='w-full h-full min-h-[250px] object-cover rounded-[10px] lg:rounded-[15px]' />
