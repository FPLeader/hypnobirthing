import { ParentsReport } from '@/services/Constants/Report'

export default function Report() {
    return (
        <div className='w-full flex justify-center'>
            <div className='w-full max-w-[1225px] mx-[20px] text-dark flex flex-col gap-[20px] md:gap-[30px]'>
                <div className='text-[30px] md:text-[40px] lg:text-[44px] text-center md:text-left font-light italic'>HypnoBirthing parents report:</div>
                <div className='grid md:grid-cols-2 gap-[15px]'>
                    {ParentsReport.map((obj: string, index: number) => (
