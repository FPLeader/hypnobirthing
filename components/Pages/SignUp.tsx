    ...
    const SignUpHandler = () => {
        if (!loadingOpen) {
            ...
            let requestParams: requestParamsProps = {
                ...
                ic_privatecourse: privateCourse,
            };

            requestParams.ar_skills = skills.map(item => item.value);
            requestParams.nm_user[lngId] = firstName.value + ' ' + lastName.value;
            requestParams.ar_personaltitle[lngId] = personalTitle.value;
            setLoadingOpen(true);
    ...
    return (
        <div className='pt-[70px] lg:pt-[90px] min-h-screen w-full flex justify-center items-center'>
            <div className='w-full mx-[20px] my-[30px] lg:my-[40px] max-w-[700px] p-[20px] md:p-[30px] lg:p-[40px] bg-bcg_2 rounded-[20px]'>
                <div dir={lngId === 0 ? 'ltr' : 'rtl'} className='flex flex-col gap-[20px]'>
                    <div className='text-center text-dark font-medium text-[26px] lg:text-[32px]'>
                        {t('Sign up')}
                    </div>
                    <div className='flex flex-col gap-[10px]'>
                        <div className='grid md:grid-cols-2 gap-[10px]'>
                            <CategoryRuleInput
                                category={t('First name')}
                        ...
                        <CategoryRuleInput
                            lngId={lngId}
                            category={t('Personal Title')}
                            placeholder={t('Example: Modern Applied Psychology & Personal Development')}
                        ...
                        <div className='flex items-center gap-[10px]'>
                            <div className='flex items-center gap-[10px]'>
                                ...
                                <label htmlFor='checkbox-two' className='text-dark text-[14px] select-none'>
                                    I agree with the <a href='#' className={style.LinkStyle}>{t('Terms of Service')}</a>, including the <a href='#' className={style.LinkStyle}>{t('User Agreement')}</a> and <a href='#' className={style.LinkStyle}>{t('Privacy Policy')}</a>.
                                </label>
                            </div>
                        </div>
                    </div>
