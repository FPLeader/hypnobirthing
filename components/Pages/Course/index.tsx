...
export default function Index({
  ...
  useEffect(() => {
    if (relatedLoaded === 0 && domLoaded === 1) {
      getCurrentUserInfor();
      getRelatedCourses();
    }
  }, [relatedLoaded, domLoaded])
    ...
    <div dir={lngId === 0 ? 'ltr' : 'rtl'} className='pt-[70px] md:pt-[90px] w-full'>
      ...
      <div className='w-full flex justify-center mt-[20px] md:mt-[30px] lg:mt-[70px]'>
        <div className='w-full max-w-[1225px] mx-[20px]'>
          <div
            className={`min-[1260px]:max-w-[805px] lg:max-w-[calc(100vw-460px)] w-full ${domLoaded === 1 && 'max-md:mt-[520px] max-lg:mt-[240px]'} flex flex-col gap-[20px] md:gap-[30px] lg:gap-[70px]`}
          >
            <AboutCourseSection
              lngId={lngId}
