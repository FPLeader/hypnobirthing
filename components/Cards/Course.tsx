...
export default function Course({
    ...
    return (
        <div className='rounded-[10px] border-[2px] border-beighe'>
            <div className='h-[38px] text-[] text-[12px] lg:text-[16px] flex justify-center items-center bg-bcg_2'>{moment(date).format('DD/MM/YYYY, dddd, HH:mm')}</div>
