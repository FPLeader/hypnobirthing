...
export default function SmallBlogSkeletonCard() {

    return (
        <div className='animate-pulse w-full h-full min-h-[137px] flex items-center gap-[15px] overflow-hidden border-[2px] border-gray-200 rounded-[10px]'>
